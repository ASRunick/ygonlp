...
図の対象となる13,179件では、2002年の平均`character_count`は134.138973（331件）、2010年は203.705373（577件）、2020年は417.811765（680件）、2025年は471.045714（525件）でした。年ごとの値は一様には変化しませんが、この範囲では後年ほど平均文字数が高い年が多く、長期的な増加傾向が見られます。2026年は途中年で、平均479.229064（406件）ですが、通年値との比較には用いません。
...
同じ13,179件の年別集計では、2002年は331件、2010年は577件、2020年は680件、2025年は525件でした。年ごとの`release_count`は変動しており、2020年の680件と2025年の525件のように、後年ほど一貫して増えるわけではありません。2026年は途中年の406件であり、他のfull yearと同列には比較しません。

この件数は、採用した`tcg_date`に基づくdataset上のTCG初出候補数であり、カード供給量やテキスト長変化の原因を示すものではありません。
